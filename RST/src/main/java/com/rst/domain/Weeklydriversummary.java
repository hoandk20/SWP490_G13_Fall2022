...
public class Weeklydriversummary {
    ...
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "WEEKNUMBERID", nullable = false)
    private Weeknumber weeknumberid;
    ...
    public Weeknumber getWeeknumberid() {
        return weeknumberid;
    }

    public void setWeeknumberid(Weeknumber weeknumberid) {
