...
@Entity
public class Proposedfarehourrateschema {
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Id
    @Column(name = "ProposedFareHourRateSchemaId", nullable = false)
    private int proposedFareHourRateSchemaId;
    @Basic
    ...
    public int getProposedFareHourRateSchemaId() {
        return proposedFareHourRateSchemaId;
    }

    public void setProposedFareHourRateSchemaId(int proposedFareHourRateSchemaId) {
        this.proposedFareHourRateSchemaId = proposedFareHourRateSchemaId;
    }
    ...
    public boolean equals(Object o) {
        ...
        Proposedfarehourrateschema that = (Proposedfarehourrateschema) o;

        if (proposedFareHourRateSchemaId != that.proposedFareHourRateSchemaId) return false;
    ...
    public int hashCode() {
        int result;
        long temp;
        result = proposedFareHourRateSchemaId;
