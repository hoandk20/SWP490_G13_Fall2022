...
public class Drivergroupfieldpermission {
    ...
    private int groupFieldPermissionId;
    @Basic
    ...
    @Basic
    @Column(name = "BUType", nullable = true, length = 10)
    ...
    public int getGroupFieldPermissionId() {
        return groupFieldPermissionId;
    }

    public void setGroupFieldPermissionId(int groupFieldPermissionId) {
        this.groupFieldPermissionId = groupFieldPermissionId;
    }
    ...
    public boolean equals(Object o) {
        ...
        Drivergroupfieldpermission that = (Drivergroupfieldpermission) o;

        if (groupFieldPermissionId != that.groupFieldPermissionId) return false;
    ...
    @Override
    public int hashCode() {
        int result = groupFieldPermissionId;
        result = 31 * result + screenId;
        result = 31 * result + (userGroup != null ? userGroup.hashCode() : 0);
        result = 31 * result + (groupFieldCode != null ? groupFieldCode.hashCode() : 0);
