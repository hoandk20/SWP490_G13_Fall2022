...
@Entity
@Table(name = "tn_paused_trigger_grps", schema = "tnet_pro", catalog = "")
@IdClass(TnPausedTriggerGrpsPK.class)
public class TnPausedTriggerGrps {
    ...
    public boolean equals(Object o) {
        ...
        TnPausedTriggerGrps that = (TnPausedTriggerGrps) o;
